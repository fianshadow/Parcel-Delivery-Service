                            ...
                            if time_parts[0].isdigit() and time_parts[1].isdigit():
                                ...
                                if (0 <= int(hour) <= 24) and (0 <= int(minute) <= 59):
                                    ...
                                    headers = ["ID", "Address", "City", "State", "Zip", "Deadline",
                                               "Weight", "Status", "Notes"]
                                    print(
                                        f'\t{headers[0]:<4}{headers[1]:^40}{headers[2]:^20}{headers[3]:^7}{headers[4]:^7}'
                                    ...
                                    print(f'\t{package.package_id[-1][0]:<4}{address:^40}{city:^20}{state:^7}'
                                          f'{zip_code:^7}{package.deadline[-1][0]:^10}{package.weight[-1][0]:^8}'
